...
proc create_root_design { parentCell } {
  ...
  set lcd [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 lcd ]
  ...
  # Create instance: Hash_Ctrl, and set properties
  set Hash_Ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 Hash_Ctrl ]
  ...
  # Create instance: Hash_data, and set properties
  set Hash_data [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 Hash_data ]
  set_property -dict [ list \
  ...
  # Create instance: Index_mem, and set properties
  set Index_mem [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 Index_mem ]
  set_property -dict [ list \
   CONFIG.Byte_Size {8} \
  ...
  set lcd [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 lcd ]
  set_property -dict [ list \
   CONFIG.C_ALL_OUTPUTS {1} \
  ...
  # Create instance: push_sw, and set properties
  set push_sw [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 push_sw ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net axi_bram_ctrl_0_BRAM_PORTA [get_bd_intf_pins Index_mem/BRAM_PORTA] [get_bd_intf_pins axi_bram_ctrl_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net lcd_GPIO [get_bd_intf_ports lcd] [get_bd_intf_pins lcd/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins push_sw/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins lcd/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins Hash_Ctrl/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins Hash_data/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  connect_bd_intf_net -intf_net push_sw_GPIO [get_bd_intf_ports push_sw] [get_bd_intf_pins push_sw/GPIO]

  # Create port connections
  connect_bd_net -net Hash_Ctrl_gpio2_io_o [get_bd_pins Hash_Ctrl/gpio2_io_o] [get_bd_pins hash_0/Seed]
  connect_bd_net -net Hash_Ctrl_gpio_io_o [get_bd_pins Hash_Ctrl/gpio_io_o] [get_bd_pins hash_0/nRST]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins Hash_data/gpio_io_o] [get_bd_pins hash_0/data_in]
  connect_bd_net -net hash_0_data_out [get_bd_pins Hash_data/gpio2_io_i] [get_bd_pins hash_0/data_out]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Hash_Ctrl/s_axi_aclk] [get_bd_pins Hash_data/s_axi_aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins hash_0/clk] [get_bd_pins lcd/s_axi_aclk] [get_bd_pins led/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins push_sw/s_axi_aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net push_sw_ip2intc_irpt [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins push_sw/ip2intc_irpt]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins Hash_Ctrl/s_axi_aresetn] [get_bd_pins Hash_data/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins lcd/s_axi_aresetn] [get_bd_pins led/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins push_sw/s_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Hash_Ctrl/S_AXI/Reg] SEG_Hash_Ctrl_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41240000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Hash_data/S_AXI/Reg] SEG_Hash_data_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs lcd/S_AXI/Reg] SEG_lcd_Reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs push_sw/S_AXI/Reg] SEG_push_sw_Reg
