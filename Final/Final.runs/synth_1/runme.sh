...
HD_PWD='C:/Users/smk62/Documents/vivado/Final/Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mcu_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mcu_wrapper.tcl
