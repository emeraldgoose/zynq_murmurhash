...
HD_PWD='C:/Users/smk62/Documents/vivado/Final/Final.runs/mcu_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mcu_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mcu_xbar_1.tcl
