...
HD_PWD='C:/Users/smk62/Documents/vivado/Final/Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mcu_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mcu_wrapper.tcl -notrace
